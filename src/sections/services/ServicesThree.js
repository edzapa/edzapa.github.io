    ...
    render() {
        ...
        return(
            <Section id="services">
                <ServiceContainer>
                    <Container>
                        <AnimatedHeading text="My Abilities" />
                        <Row>
                            <Col md={4}>
                                <AnimationContainer animation="fadeInLeft" delay={200}>
                                        <ServiceElement>
                                            <ServiceIcon>
                                                    <img src={this.props.mobile.childImageSharp.fluid.src} alt="Software Development" />
                                            </ServiceIcon>
                                            <ServiceHeading>
                                            ...
                                            <ServiceList>
                                                <ServiceListElement>
                                                    Enrolled in modules like software engineering
                                                </ServiceListElement>
                                                <ServiceListElement>
                                                    Building programs using Python and Java
                                                </ServiceListElement>
                                                <ServiceListElement>
                                                    Always brainstorming for the next project
                                                </ServiceListElement>
                                            </ServiceList>
                                        </ServiceElement>
                                </AnimationContainer>
                            ...
                            <Col md={4}>
                                <AnimationContainer animation="fadeInRight" delay={600}>
                                    <ServiceElement>
                                        <ServiceIcon>
                                                <img src={this.props.email.childImageSharp.fluid.src} alt="Software Development" />
                                        </ServiceIcon>
                                        <ServiceHeading>
                                            Machine Learning
                                        </ServiceHeading>
                                        ...
                                        <ServiceList>
                                            <ServiceListElement>
                                                Developed a MNIST digit recogniser
                                            </ServiceListElement>
                                            <ServiceListElement>
                                                Exploring various subfields in machine learning
                                            </ServiceListElement>
                                            <ServiceListElement>
                                                Learning to implement more effective algorithms
                                            </ServiceListElement>
                                        </ServiceList>
                                    </ServiceElement>
                                </AnimationContainer>
                            ...
                            <Col md={4}>
                                <AnimationContainer animation="fadeInLeft" delay={800}>
                                    <ServiceElement>
                                        ...
                                        <ServiceList>
                                            <ServiceListElement>
                                                Learnt about cyber secuirity measures in data centres
                                            </ServiceListElement>
                                            <ServiceListElement>
                                                Breaking into and upskilling in cyber secuirity using TryHackMe
                                            </ServiceListElement>
                                            <ServiceListElement>
                                                Developed a Caesar cipher to decrypt and encrypt strings
                                            </ServiceListElement>
                                        </ServiceList>
                                    </ServiceElement>
                                </AnimationContainer>
                            ...
                            <Col md={4}>
                                <AnimationContainer animation="fadeInUp" delay={1000}>
                                    <ServiceElement>
                                        <ServiceIcon>
                                                <img src={this.props.network.childImageSharp.fluid.src} alt="Software Development" />
                                        </ServiceIcon>
                                        <ServiceHeading>
                                            Web Development
                                        </ServiceHeading>
                                        ...
                                        <ServiceList>
                                            <ServiceListElement>
                                                Building responsive websites with JS
                                            </ServiceListElement>
                                            <ServiceListElement>
                                                Developed a portfolio website using Node.js
                                            </ServiceListElement>
                                            <ServiceListElement>
                                                Taking part in The Odin Project
                                            </ServiceListElement>
                                        </ServiceList>
                                    </ServiceElement>
                                </AnimationContainer>
                            ...
                            <Col md={4}>
                                    <AnimationContainer animation="fadeInRight" delay={1200}>
                                        <ServiceElement>
                                            <ServiceIcon>
                                                    <img src={this.props.ui.childImageSharp.fluid.src} alt="Software Development" />
                                            </ServiceIcon>
                                            <ServiceHeading>
                                                Financial Computing
                                            </ServiceHeading>
