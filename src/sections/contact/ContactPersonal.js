                  ...
                  <AnimationContainer animation="fadeIn">
                    <FormRow>
                      ...
                      <ContactCol md={6}>
                        <Map  
                          title="map"
                          src="https://maps.google.com/maps?width=500&amp;height=500&amp;hl=en&amp;q=university%20of%20liverpool&t=k&z=15&ie=UTF8&iwloc=&output=embed"/>
                      </ContactCol>
                    </FormRow>
                  </AnimationContainer>
                  <IconRow>
                        ...
                        <AnimationContainer animation="fadeIn" delay={500}>
                          <InfoPart>
                            ...
                            <Info>
                              ...
                              <InfoLinkContainer>
                                <InfoLink href="mailto:edvinadev@protonmail.com">
                                  edvinadev@protonmail.com
                                </InfoLink>
                              </InfoLinkContainer>
                            </Info>
                          </InfoPart>
                        ...
                        <AnimationContainer animation="fadeIn" delay={1000}>
                          <InfoPart>
                            ...
                            <Info>
                              ...
                              <InfoLinkContainer>
                                <InfoLink href="https://www.linkedin.com/in/edvinaambro/">
                                  edvinaambro
                                </InfoLink>
                              </InfoLinkContainer>
                            </Info>
                        ...
                        <AnimationContainer animation="fadeIn" delay={1500}>
                          <InfoPart>
                            ...
                            <Info>
                              ...
                              <InfoLinkContainer>
                                <InfoLink target="_blank" href="https://github.com/edzapa">
                                  edzapa
                                </InfoLink>
                              </InfoLinkContainer>
                            </Info>
